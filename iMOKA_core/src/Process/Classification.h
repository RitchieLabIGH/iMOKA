...
public:
	...
	bool classificationFilter(std::string file_in, std::string file_out, std::string method , std::string batch, uint64_t cv,double sd, double acc, double perc_training, std::vector<double> adjustments);
	bool classificationFilterMulti(std::string file_in, std::string file_out, std::string method , std::string batch, uint64_t cv,double sd, double acc, double perc_training, std::vector<double> adjustments);
	...
	bool clusterizationFilter(std::string input, std::string output, std::string method,
