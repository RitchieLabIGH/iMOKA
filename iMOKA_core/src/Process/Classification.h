...
public:
	...
	bool classificationFilterMulti(std::string file_in, std::string file_out, int min , uint64_t entropy_evaluation , uint64_t cv,double sd, double acc, double perc_training, std::vector<double> adjustments);
