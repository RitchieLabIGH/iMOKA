...
sudo singularity build -F ${singularity_final_name} docker-daemon://cloxd/imoka:${imoka_version} && sudo singularity build -F ${singularity_extended_name} ${singularity_extended_recipe}.tmp
